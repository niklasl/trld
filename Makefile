trld_modules = trld/jsonld/base.py trld/jsonld/expansion.py trld/jsonld/compaction.py trld/jsonld/flattening.py trld/jsonld/rdf.py trld/jsonld/testbase.py trld/nq/parser.py trld/nq/serializer.py trld/trig/parser.py trld/trig/serializer.py trld/c14n.py trld/rdfxml/parser.py trld/rdfxml/serializer.py trld/tvm/mapmaker.py trld/tvm/mapper.py trld/tvm/test.py -I trld/builtins.py trld/platform/*.py
