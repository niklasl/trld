trld_modules = trld/jsonld/expansion.py trld/jsonld/compaction.py trld/jsonld/flattening.py trld/jsonld/rdf.py trld/jsonld/testcase.py trld/nq/parser.py trld/nq/serializer.py trld/trig/parser.py trld/tvm/mapmaker.py trld/tvm/mapper.py -I trld/common.py
